 ...
 * &quot;notification_type_lu&quot; table. Since lookup id/value pairs do not
 ...
 * @since 1.0
 */
public class NotificationTypeLookupUtility {
    /**
     * <p>
     ...
     * lookup value.
     */
    private static final String SQL_QUERY = "SELECT notification_type_id FROM notification_type_lu WHERE name = ?";

    /**
     * Private constructor to prevent class initialization.
     *
     */
    private NotificationTypeLookupUtility() {
        // do nothing.
    }

    /**
     * Gets the &quot;upload_type_id&quot; for the given value for
     * &quot;name&quot; from &quot;notification_type_lu&quot; table. This method
