 ...
 * &quot;upload_status_lu&quot; table. Since lookup id/value pairs do not change
 ...
 * @since 1.0
 */
public class UploadStatusLookupUtility {
    /**
     * <p>
     ...
     * lookup value.
     */
    private static final String SQL_QUERY = "SELECT upload_status_id FROM upload_status_lu WHERE name = ?";

    /**
     * Private constructor to prevent class initialization.
     *
     */
    private UploadStatusLookupUtility() {
        // do nothing.
    }

    /**
     * Gets the &quot;upload_status_id&quot; for the given value for
     * &quot;name&quot; from &quot;upload_status_lu&quot; table. This method
     ...
     *
     * @return The corresponding &quot;upload_status_id&quot;.
     *
