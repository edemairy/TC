...
/**
 * <p>
 * This class provides the function to get lookup id for a lookup name from the
 * &quot;phase_status_lu&quot; table. Since lookup id/value pairs do not change
 * in the database per installation, this class caches the id/value pairs to
 * minimize queries to the database. This class is used in various methods of
...
public class PhaseStatusLookupUtility {
     ...
     * lookup value.
     */
    private static final String SQL_QUERY = "SELECT phase_status_id FROM phase_status_lu WHERE name = ?";

    /**
     * Private constructor to prevent class initialization.
     *
     */
    private PhaseStatusLookupUtility() {
        // do nothing.
    }

    /**
     * Gets the &quot;phase_status_id&quot; for the given value for
     * &quot;name&quot; from &quot;phase_status_lu&quot; table. This method uses
     * caching mechanism for id/value pairs to minimize queries to the database.
     * Hence if the lookup id is present in the cache, it is returned without
     * hitting the database. It is synchronized to ensure thread safety.
     *
     * @param connection The connection used to access the persistence.
     * @param value The value for &quot;name&quot; column.
     *
     * @return The corresponding &quot;phase_status_id&quot;.
     *
