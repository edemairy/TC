 ...
 * &quot;resource_role_lu&quot; table. Since lookup id/value pairs do not change
 ...
 * @since 1.0
 */
public class ResourceRoleLookupUtility {
    /**
     * <p>
     ...
     * lookup value.
     */
    private static final String SQL_QUERY = "SELECT resource_role_id FROM resource_role_lu WHERE name = ?";

    /**
     * Private constructor to prevent class initialization.
     *
     */
    private ResourceRoleLookupUtility() {
        // do nothing.
    }

    /**
     * Gets the &quot;resource_role_id&quot; for the given value for
     * &quot;name&quot; from &quot;resource_role_lu&quot; table. This method
     ...
     *
     * @return The corresponding &quot;resource_role_id&quot;.
     *
