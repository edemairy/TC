...
public class RegistrationPhaseHandlerTest extends BaseTest {
    ...
    public void testRegistrationPhaseHandler() throws Exception {
        ...
        try {
            ...
            assertTrue("can stop should return false", handler.canPerform(registration));
    ...
    /**
     * Tests the perform with open status and with registration. The post-mortem phase should not be inserted in such a
     * situation.
     *
     * @throws Exception to JUnit.
     *
