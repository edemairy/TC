 ...
 * </p>
 * <p>
 * Unfortunately, as this component can not really be described in a full customer scenario without
 * including all the other components up for design this week, this demo will not be a customer
 * oriented demo but a rundown of the requirements in a demo form. Where it makes sense, examples of
 * what a customer might do with the information are shown.
 * </p>
 *
...
public class Demo extends TestCase {
    ...
    public void testDemo() throws Exception {
        ...
        DeliverablePersistence deliverablePersistence = new SqlDeliverablePersistence(
