...
public class DeliverableTests extends TestCase {
    ...
    /**
     * Test constructor1 with invalid parameters. The first argument will be set to 0.
    ...
    /**
     * Test constructor1 with invalid parameters. The first argument will be set to -1.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Test constructor1 with invalid parameters. The second argument will be set to 0.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Test constructor1 with invalid parameters. The second argument will be set to -1.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Test constructor1 with invalid parameters. The third argument will be set to 0.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Test constructor1 with invalid parameters. The third argument will be set to -1.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Test constructor1 with invalid parameters. The fourth argument will be set to 0.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Test constructor1 with invalid parameters. The fourth argument will be set to -1.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Test constructor1 with valid parameter. Check if the constructor set all the private fields
     * properly. No exception should be thrown.
     */
    ...
    /**
     * Test the behavior of getProject. Set the project field in the constructor, see if the
     * getProject method can get the correct value. No exception should be thrown.
     */
    ...
    /**
     * Test the behavior of getPhase. Set the phase field in the constructor, see if the getPhase
    ...
    /**
     * Test the behavior of getResource. Set the resource field in the constructor, see if the
     * getResource method can get the correct value. No exception should be thrown.
     */
    ...
    /**
     * Test the behavior of getSubmission. Set the submission field in the constructor, see if the
     * getSubmission method can get the correct value. No exception should be thrown.
     */
    ...
    /**
     * Test the behavior of IsRequired. Set the isRequired field in the constructor, see if the
     * IsRequired method can get the correct value. No exception should be thrown.
     */
    ...
    /**
     * Test the behavior of setCompletionDate. Set the completionDate field, see if the
     * getCompletionDate method can get the correct value. No exception should be thrown.
     */
    ...
    /**
     * Test the behavior of GetCompletionDate. Set the completionDate field, see if the
     * getCompletionDate method can get the correct value. No exception should be thrown.
     */
    ...
    /**
     * Test the behavior of isComplete. Set the completionDate field, see if the
     * isComplete method can get a true. No exception should be thrown.
     */
    ...
    /**
     * Test the behavior of isComplete. Left completionDate field with a null value, see if the
     * isComplete method can get a false. No exception should be thrown.
     */
    ...
    /**
     * Test the behavior of isPerSubmission. Set the submission field, see if the
     * isPerSubmission method can get a true. No exception should be thrown.
     */
    ...
    /**
     * Test the behavior of isPerSubmission. Left submission field with a null value, see if the
     * isPerSubmission method can get a false. No exception should be thrown.
     */
