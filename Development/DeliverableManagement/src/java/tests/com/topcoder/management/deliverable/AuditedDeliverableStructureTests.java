...
public class AuditedDeliverableStructureTests extends TestCase {
    ...
    /**
     * Test the behavior of setId. Set the id field when it was already set. IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Test the behavior of setId. Set the id field, see if the getId method can get the correct
    ...
    /**
     * Test the behavior of getId. Set the id field, see if the getId method can get the correct
     * value. No exception should be thrown.
     */
