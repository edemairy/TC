...
/**
 * <p>
 * The PersistenceUploadManager class implements the UploadManager interface. It ties together a persistence
 * mechanism, several Search Builder instances (for searching for various types of data), and several id generators
 * (for generating ids for the various types). This class consists of several methods styles. The first method style
 * just calls directly to a corresponding method of the persistence. The second method style first assigns values to
 * some data fields of the object before calling a persistence method. The third type of method uses a SearchBundle to
 * execute a search and then uses the persistence to load an object for each of the ids found from the search.
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @author aubergineanode, singlewood, George1, saarixx, sparemax
 * @version 1.1
 */
public class PersistenceUploadManager implements UploadManager {
    ...
    public void updateUpload(Upload upload, String operator) throws UploadPersistenceException {
        ...
        LOGGER.log(Level.INFO, new LogMessage("Upload", id, operator, "Update Upload."));
    ...
    public void removeUpload(Upload upload, String operator) throws UploadPersistenceException {
        ...
        LOGGER.log(Level.INFO, new LogMessage("Upload", id, operator, "Remove Upload."));
    ...
    public Upload getUpload(long id) throws UploadPersistenceException {
        LOGGER.log(Level.INFO, new LogMessage("Upload", new Long(id), null,
            "Retrieve Upload, delegate to persistence."));
    ...
    public void updateUploadType(UploadType uploadType, String operator) throws UploadPersistenceException {
        ...
        LOGGER.log(Level.INFO, new LogMessage("UploadType", id, operator, "update UploadType."));
    ...
    public void removeUploadType(UploadType uploadType, String operator) throws UploadPersistenceException {
        ...
        LOGGER.log(Level.INFO, new LogMessage("UploadType", id, operator, "remove UploadType."));
    ...
    public void updateUploadStatus(UploadStatus uploadStatus, String operator)
        ...
        LOGGER.log(Level.INFO, new LogMessage("UploadStatus", id, operator, "create new UploadStatus."));
    ...
    public void removeUploadStatus(UploadStatus uploadStatus, String operator)
        ...
        LOGGER.log(Level.INFO, new LogMessage("UploadStatus", id, operator, "remove UploadStatus."));
    ...
    public void updateSubmission(Submission submission, String operator) throws UploadPersistenceException {
        ...
        LOGGER.log(Level.INFO, new LogMessage("Submission", id, operator, "update Submission."));
    ...
    public void removeSubmission(Submission submission, String operator) throws UploadPersistenceException {
        ...
        LOGGER.log(Level.INFO, new LogMessage("Submission", id, operator, "remove Submission."));
    ...
    public Submission getSubmission(long id) throws UploadPersistenceException {
        LOGGER.log(Level.INFO, new LogMessage("Submission", new Long(id), null,
            "Retrieve Submission, delegate to persistence."));
    ...
    public void updateSubmissionStatus(SubmissionStatus submissionStatus, String operator)
        ...
        LOGGER.log(Level.INFO, new LogMessage("SubmissionStatus", id, operator, "update SubmissionStatus."));
    ...
    public void removeSubmissionStatus(SubmissionStatus submissionStatus, String operator)
        ...
        LOGGER.log(Level.INFO, new LogMessage("SubmissionStatus", id, operator, "remove SubmissionStatus."));
    ...
    public void updateSubmissionType(SubmissionType submissionType, String operator)
        throws UploadPersistenceException {
        Long id = new Long(submissionType == null ? -1 : submissionType.getId());

        LOGGER.log(Level.INFO, new LogMessage("SubmissionType", id, operator, "Update SubmissionType."));
    ...
    public void removeSubmissionType(SubmissionType submissionType, String operator)
        ...
        LOGGER.log(Level.INFO, new LogMessage("SubmissionType", id, operator, "Remove SubmissionType."));
     ...
     * @throws IllegalArgumentException
     *             if obj or operator is <code>null</code>, id is not UNSET_ID, or the obj
     *             (once an id and creation/modification user/date are assigned) is not in a state to be persisted
     *             (i.e. if isValidToPersist returns false).
     * @throws UploadPersistenceException If there is an error making the change in the persistence
     */
