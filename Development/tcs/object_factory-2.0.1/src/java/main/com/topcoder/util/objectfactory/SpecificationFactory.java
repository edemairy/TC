...
/**
 * <p>Interface to the factory that will supply specifications. Currently there is one implementation -
 * ConfigManagerSpecificationFactory. There are no restrictions on the constructors or the way the
 * specifications are assesmbled before or during the call.</p>
 *
 * @author codedoc, mgmg
 * @version 2.0
 */
public interface SpecificationFactory {
     ...
     * can use one or two keys to uniquely identify an configuration for an object.</p>
     *
     ...
     *
     * @throws UnknownReferenceException If the key/identifier combination is not recognized
