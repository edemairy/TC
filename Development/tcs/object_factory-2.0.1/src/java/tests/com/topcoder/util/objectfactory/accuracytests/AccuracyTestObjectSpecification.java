...
public class AccuracyTestObjectSpecification extends TestCase {
    ...
    private static final String JAR_VALUE =
        "file:///" + new File("test_files/accuracytests/MockClass2.jar").getAbsolutePath();
    ...
    public void testConstructorSimpleInt() {
        os = new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, JAR_VALUE,
    ...
    public void testConstructorSimpleChar() {
        os = new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, JAR_VALUE,
                ObjectSpecification.CHAR, IDENTIFIER_VALUE, CHAR_VALUE, 1, null);
    ...
    public void testConstructorSimpleBoolean() {
        os = new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, JAR_VALUE,
                ObjectSpecification.BOOLEAN, IDENTIFIER_VALUE, BOOLEAN_VALUE, 1, null);
    ...
    public void testConstructorSimpleString() {
        os = new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, JAR_VALUE,
                ObjectSpecification.STRING, IDENTIFIER_VALUE, STRING_VALUE, 1, null);
    ...
    public void testObjectSpecificationComplex() {
        final ObjectSpecification os1 =
            new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, JAR_VALUE,
                ObjectSpecification.FLOAT, IDENTIFIER_VALUE, FLOAT_VALUE, 1, null);
        final ObjectSpecification os2 =
            new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, JAR_VALUE,
                ObjectSpecification.DOUBLE, IDENTIFIER_VALUE, DOUBLE_VALUE, 1, null);
    ...
    public void testObjectSpecificationArray() {
        ...
        final ObjectSpecification os2 =
            new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, JAR_VALUE,
                ObjectSpecification.SHORT, IDENTIFIER_VALUE, SHORT_VALUE, 1, null);
        final ObjectSpecification os3 =
            new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, JAR_VALUE,
                ObjectSpecification.LONG, IDENTIFIER_VALUE, LONG_VALUE, 1, null);
        final ObjectSpecification os4 =
            new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, JAR_VALUE,
                ObjectSpecification.BYTE, IDENTIFIER_VALUE, BYTE_VALUE, 1, null);

        os = new ObjectSpecification(ObjectSpecification.ARRAY_SPECIFICATION, JAR_VALUE,
                ObjectSpecification.STRING, IDENTIFIER_VALUE, null, 2,
    ...
    public void testObjectSpecificationNull() {
        os = new ObjectSpecification(ObjectSpecification.NULL_SPECIFICATION, JAR_VALUE,
                ObjectSpecification.STRING, IDENTIFIER_VALUE, null, 1, null);
