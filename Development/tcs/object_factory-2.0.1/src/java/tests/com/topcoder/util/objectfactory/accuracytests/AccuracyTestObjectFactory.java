...
public class AccuracyTestObjectFactory extends AccuracyTestBaseClass {
    ...
    public void testGetAndSetInitStrategy() throws Exception {
        objectFactory =
            new ObjectFactory(new ConfigManagerSpecificationFactory(COMPLEX_NAMESPACE),
    ...
    public void testCreateObjectIntArray1() throws Exception {
        objectFactory =
            new ObjectFactory(new ConfigManagerSpecificationFactory(INT_ARRAY_NAMESPACE),
                ObjectFactory.SPECIFICATION_ONLY);
    ...
    public void testCreateObjectCharArray() throws Exception {
        objectFactory =
            new ObjectFactory(new ConfigManagerSpecificationFactory(CHAR_ARRAY_NAMESPACE),
                ObjectFactory.SPECIFICATION_ONLY);
    ...
    public void testCreateObjectStringArray() throws Exception {
        objectFactory =
            new ObjectFactory(new ConfigManagerSpecificationFactory(STRING_ARRAY_NAMESPACE),
                ObjectFactory.SPECIFICATION_ONLY);
    ...
    public void testCreateObjectComplexArray() throws Exception {
        objectFactory =
            new ObjectFactory(new ConfigManagerSpecificationFactory(INTEGER_ARRAY_NAMESPACE),
                ObjectFactory.SPECIFICATION_ONLY);
    ...
    public void testCreateObjectString() throws Exception {
        ...
        assertTrue("The object is not valid.",
            objectFactory.createObject("java.lang.StringBuffer").toString().equals(""));
    }
    ...
    public void testCreateObjectClass() throws Exception {
        ...
        assertTrue("The object is not valid.",
            objectFactory.createObject(StringBuffer.class).toString().equals(""));
    }
    ...
    public void testCreateObjectStringStringURLObjectArrayClassArrayString() throws Exception {
        ...
        MockClass2 mock2 =
            (MockClass2) objectFactory.createObject(MOCK_CLASS_NAME, IDENTIFIER, url,
                new Object[] {new StringBuffer("test"), new ArrayList(), null},
                new Class[] {StringBuffer.class, ArrayList.class, ArrayList.class},
                ObjectFactory.REFLECTION_ONLY);
    ...
    public void testCreateObjectClassStringURLObjectArrayClassArrayString() throws Exception {
        ...
        MockClass2 mock2 =
            (MockClass2) objectFactory.createObject(clazz, IDENTIFIER, url,
                new Object[] {new StringBuffer("test"), new ArrayList(), null},
                new Class[] {StringBuffer.class, ArrayList.class, ArrayList.class},
                ObjectFactory.REFLECTION_ONLY);
    ...
    public void testCreateObjectStringStringClassLoaderObjectArrayClassArrayString() throws Exception {
        ...
        MockClass2 mock2 =
            (MockClass2) objectFactory.createObject(MOCK_CLASS_NAME, IDENTIFIER,
