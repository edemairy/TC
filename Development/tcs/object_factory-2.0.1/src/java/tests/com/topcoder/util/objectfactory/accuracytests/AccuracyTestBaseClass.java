...
public class AccuracyTestBaseClass extends TestCase {
    ...
    protected static final String INT_ARRAY_NAMESPACE =
        "AccuracyTestConfigManagerSpecificationFactory.intArray";

    /** The value of the namespace of the type of char array used for test. */
    protected static final String CHAR_ARRAY_NAMESPACE =
        "AccuracyTestConfigManagerSpecificationFactory.charArray";

    /** The value of the namespace of the type of String array used for test. */
    protected static final String STRING_ARRAY_NAMESPACE =
        "AccuracyTestConfigManagerSpecificationFactory.StringArray";

    /** The value of the namespace of the type of Integer array used for test. */
    protected static final String INTEGER_ARRAY_NAMESPACE =
        "AccuracyTestConfigManagerSpecificationFactory.IntegerArray";
