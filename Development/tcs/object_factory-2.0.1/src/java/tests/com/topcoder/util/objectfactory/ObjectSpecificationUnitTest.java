...
public class ObjectSpecificationUnitTest extends TestCase {
    ...
    public void setUp() {
        ...
        specifications[1] =
            new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, null, "String", null, "aaa", 1,
                null);
        instance =
            new ObjectSpecification(ObjectSpecification.COMPLEX_SPECIFICATION,
    ...
    /**
     * Test constructor with null type and simple type.
     * IllegalArgumentException should be thrown because of the invalid parameter.
     */
    ...
    /**
     * Test constructor with valid simple type.
     * No exception will be thrown.
     */
    public void testConstructor_SimpleAccuracy() {
        ObjectSpecification obj =
            new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, null, "int", null, "5", 3,
                new Object[0]);
    ...
    /**
     * Test constructor with null type and array type.
     * IllegalArgumentException should be thrown because of the invalid parameter.
     */
    public void testConstructor_ArrayNullType() {
        try {
            new ObjectSpecification(ObjectSpecification.ARRAY_SPECIFICATION, null, null, null, null, 2,
    ...
    public void testConstructor_ArrayInvalidType() {
        try {
            new ObjectSpecification(ObjectSpecification.ARRAY_SPECIFICATION, null, "abc", null, null, 2,
                new Object[] {new Object[] {new Integer(1)}, new Object[] {new Integer(45)}});
            fail("IllegalArgumentException should be thrown because of the invalid parameter.");
        } catch (IllegalArgumentException e) {
            // expected.
    ...
    public void testConstructor_ArrayInvalidArray() {
        try {
            new ObjectSpecification(ObjectSpecification.ARRAY_SPECIFICATION, null, "java.lang.Integer", null,
                null, 2,
    ...
    public void testConstructor_ArrayInvalidDimension1() {
        try {
            new ObjectSpecification(ObjectSpecification.ARRAY_SPECIFICATION, null, "java.lang.Integer", null,
                null, 1, new Object[] {new Object[] {new Integer(1)}, new Object[] {new Integer(45)}});
            fail("IllegalArgumentException should be thrown because of the invalid parameter.");
        } catch (IllegalArgumentException e) {
            // expected.
        }
    ...
    public void testConstructor_ArrayInvalidDimension2() {
        try {
            new ObjectSpecification(ObjectSpecification.ARRAY_SPECIFICATION, null, "java.lang.Integer", null,
                null, -2, new Object[] {new Object[] {new Integer(1)}, new Object[] {new Integer(45)}});
            fail("IllegalArgumentException should be thrown because of the invalid parameter.");
        } catch (IllegalArgumentException e) {
            // expected.
        }
    ...
    /**
     * Test constructor with valid array type.
     * No exception will be thrown.
     */
    ...
    /**
     * Test constructor with simple type of null type.
     * IllegalArgumentException should be thrown because of the invalid parameter.
     */
    public void testConstructor_NullSimpleType() {
        try {
            new ObjectSpecification(ObjectSpecification.NULL_SPECIFICATION, null, ObjectSpecification.FLOAT,
                null, null, 1, null);
            fail("IllegalArgumentException should be thrown because of the invalid parameter.");
        } catch (IllegalArgumentException e) {
            // expected.
    ...
    /**
     * Test constructor with null type of null type.
     * IllegalArgumentException should be thrown because of the invalid parameter.
     */
    ...
    /**
     * Test constructor with invalid type of null type.
     * IllegalArgumentException should be thrown because of the invalid parameter.
     */
    ...
    /**
     * Test constructor with valid null type.
     * No exception will be thrown.
     */
    public void testConstructor_NullAccuracy() {
        ObjectSpecification obj =
            new ObjectSpecification(ObjectSpecification.NULL_SPECIFICATION, null, "java.lang.Integer", null,
                "abc", 4, null);
    ...
    /**
     * Test constructor with null type of complex type.
     * IllegalArgumentException should be thrown because of the invalid parameter.
     */
    ...
    public void testConstructor_ComplexSimpleType() {
        try {
            new ObjectSpecification(ObjectSpecification.COMPLEX_SPECIFICATION, null, ObjectSpecification.BYTE,
                null, null, 1, null);
            fail("IllegalArgumentException should be thrown because of the invalid parameter.");
        } catch (IllegalArgumentException e) {
            // expected.
    ...
    /**
     * Test constructor with valid parameter of complex type.
     * No exception will be thrown.
     */
    public void testConstructor_ComplexAccuracy1() {
        ObjectSpecification obj =
            new ObjectSpecification(ObjectSpecification.COMPLEX_SPECIFICATION, null, "java.util.ArrayList",
                "arraylist", null, 1,
                new ObjectSpecification[] {
                    new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, null, "int", null, "5",
                        1, null)
                });
        ...
        ObjectSpecification obj =
            new ObjectSpecification(ObjectSpecification.COMPLEX_SPECIFICATION,
                ...
                new ObjectSpecification[] {
                    new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, null, "int", null, "5",
                        1, null),
                    new ObjectSpecification(ObjectSpecification.SIMPLE_SPECIFICATION, null, "String", null,
                        "aaa", 1, null)
                });
