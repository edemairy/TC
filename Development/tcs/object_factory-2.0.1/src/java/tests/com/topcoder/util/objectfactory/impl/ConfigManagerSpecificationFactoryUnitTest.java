...
import com.topcoder.util.objectfactory.TestHelper;
...
public class ConfigManagerSpecificationFactoryUnitTest extends TestCase {
    ...
    /**
     * Test the constructor with the null namespace.
    ...
    /**
     * Test the constructor with the invalid config.
     * IllegalReferenceException should be thrown.
     *
     * @throws Exception exception to JUnit.
     */
    ...
    /**
     * Test the constructor with valid config namespace.
    ...
    /**
     * Test getObjectSpecification with null key.
     * IllegalArgumentException should be thrown.
     *
     * @throws Exception exception to JUnit.
     */
    ...
    /**
     * Test getObjectSpecification with empty key.
     * IllegalArgumentException should be thrown.
     *
     * @throws Exception exception to JUnit.
     */
    ...
    /**
     * Test getObjectSpecification with valid key.
     * No exception will be thrown.
     *
     * @throws Exception exception to JUnit.
     */
    public void testGetObjectSpecification_Accuracy1() throws Exception {
        ...
        assertEquals("The type is wrong.", "com.topcoder.util.objectfactory.testclasses.TestClass1",
            spec.getType());
