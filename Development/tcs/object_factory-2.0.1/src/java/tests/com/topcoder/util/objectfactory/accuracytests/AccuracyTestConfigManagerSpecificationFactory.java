...
public class AccuracyTestConfigManagerSpecificationFactory extends AccuracyTestBaseClass {
    ...
    public void testGetObjectSpecificationComplex() throws Exception {
        ...
        assertEquals("The type is not valid.", "com.topcoder.util.objectfactory.accuracytests.MockClass1",
            os.getType());
    ...
    private void checkMockClass1Parameters(Object[] parameters) {
        ...
        assertEquals("The specType is not valid.", ObjectSpecification.SIMPLE_SPECIFICATION,
            param1.getSpecType());
        ...
        assertEquals("The specType is not valid.", ObjectSpecification.COMPLEX_SPECIFICATION,
            param3.getSpecType());
        assertNull("The jar should be null.", param3.getJar());
        assertEquals("The type is not valid.", "com.topcoder.util.objectfactory.accuracytests.MockClass2",
            param3.getType());
