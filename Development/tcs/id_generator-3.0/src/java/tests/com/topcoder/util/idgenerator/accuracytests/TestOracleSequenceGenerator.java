...
public class TestOracleSequenceGenerator extends TestCase {
    ...
    private static final String SEQ_NAME_NORMAL = "accuracytests_oracle_test_noraml";
   
    /** The sequence name for big integer generation. */
    private static final String SEQ_NAME_BIG = "accuracytests_oracle_test_big";
  
    /** The first number in the sequence. */
    private static final long FIRST_NUM_NORMAL = 10;

    /** The last number in the sequence. */
    private static final long LAST_NUM_NORMAL = 10000;

    /** The first number in the sequence. */
    private static final BigInteger FIRST_NUM_BIG = new BigInteger(Long.toString(100));

    /** The last number in the sequence. */
    private static final BigInteger LAST_NUM_BIG = new BigInteger(Long.toString(500));
    ...
    public void testSequenceGeneration_big() throws Exception {
        ...
        // Test sequence generation.
        for (BigInteger expectedID = FIRST_NUM_BIG; expectedID.compareTo(LAST_NUM_BIG) != 1; expectedID.add(BigInteger.ONE)) {
