...
public final class TestHelper {
    ...
    public static void addConfig() throws Exception {
        ...
        cm.add("hibernateSearchStrategyConfig.xml");
    }
    ...
    public static void delEntriesForLikeFilter() throws Exception {
        ...
        try {
            ...
            deleteEntry(con, "cn=s1,dc=guessant,dc=org");
            deleteEntry(con, "cn=s2,dc=guessant,dc=org");
            deleteEntry(con, "cn=s3,dc=guessant,dc=org");
            deleteEntry(con, "cn=s4,dc=guessant,dc=org");
            deleteEntry(con, "cn=s5,dc=guessant,dc=org");
            deleteEntry(con, "cn=s6,dc=guessant,dc=org");
            deleteEntry(con, "cn=s7,dc=guessant,dc=org");
            deleteEntry(con, "cn=s8,dc=guessant,dc=org");
        } finally {
            if (con != null) {
                con.disconnect();
            }
     ...
     *            the entry to delete.
     */
    private static void deleteEntry(LDAPSDKConnection con, String dn) {
        try {
            con.deleteEntry(dn);
        } catch (Exception e) {
            // ignore
    ...
    public static void delEntries() throws Exception {
        ...
        try {
            ...
            deleteEntry(con, "cn=test1,dc=guessant,dc=org");
            deleteEntry(con, "cn=test2,dc=guessant,dc=org");
            deleteEntry(con, "cn=test3,dc=guessant,dc=org");
            deleteEntry(con, "cn=test4,dc=guessant,dc=org");
            deleteEntry(con, "cn=test5,dc=guessant,dc=org");
            deleteEntry(con, "cn=s1,dc=guessant,dc=org");
            deleteEntry(con, "cn=s2,dc=guessant,dc=org");
            deleteEntry(con, "cn=s3,dc=guessant,dc=org");
            deleteEntry(con, "cn=s4,dc=guessant,dc=org");
