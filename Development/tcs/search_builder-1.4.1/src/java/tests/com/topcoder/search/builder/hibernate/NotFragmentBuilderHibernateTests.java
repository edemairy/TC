 ...
 * @version 1.4
 */
public class NotFragmentBuilderHibernateTests extends TestCase {
    /**
     * The namespace.
     */
    ...
    /**
     * The failure test of buildSearch, fail for filter not NotFilter,
    ...
    public void testbuildSearch_accuracy() throws Exception {
        ...
        assertEquals("the generated String should be same.", "NOT (sn = ?)",
