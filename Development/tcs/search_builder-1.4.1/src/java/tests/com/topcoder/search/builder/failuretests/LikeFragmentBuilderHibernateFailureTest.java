...
/**
 * <p>
 * Failure test cases for <code>LikeFragmentBuilder</code>.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.4
 */
public class LikeFragmentBuilderHibernateFailureTest extends BaseFragmentBuilderHibernateTest {
    ...
    public void testBuildSearchWithFilterNull() throws Exception {
        try {
            new LikeFragmentBuilder().buildSearch(null, searchContext);
    ...
    public void testBuildSearchWithSearchContextNull() throws Exception {
        try {
            new LikeFragmentBuilder().buildSearch(new LikeFilter("sn", "EW:2"), null);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
     ...
     * <p>
     * Failure test for the method <code>buildSearch(Filter filter, SearchContext searchContext)</code> with the
     * filter is not LikeFilter, UnrecognizedFilterException is expected.
     * </p>
     *
     * @throws Exception
     *             to JUnit
    ...
    public void testBuildSearchWithFilterIncorrectType() throws Exception {
        try {
            new LikeFragmentBuilder().buildSearch(new EqualToFilter("sb", "2"), searchContext);
