...
public class SearchBundleTests extends TestCase {
    ...
    public void testconstruct_accuracy2() {
        assertNotNull("can not construct the dbSearchBundle",
            new SearchBundle(NAME, fields, aliasMap, "context"));
    }
    ...
    public void testconstruct9() {
        try {
            dbSearchBundle = new SearchBundle(NAME, new HashMap(), aliasMap,
                    "context");
            fail("IllegalArgumentException should be throw");
        } catch (IllegalArgumentException e) {
            //success
    ...
    public void testconstruct16() {
        try {
            dbSearchBundle = new SearchBundle(NAME, fields, aliasMap,
                    "context", strategy);
        } catch (Exception e) {
            fail("No Exception should be throw");
        }
    ...
    public void testconstruct17() {
        try {
            dbSearchBundle = new SearchBundle(null, fields, aliasMap,
                    "context", strategy);
            fail("IllegalArgumentException should be throw");
        } catch (IllegalArgumentException e) {
            //success
    ...
    public void testbuildGreaterThanOrEqualToFilter() {
        ...
        try {
            filter = new GreaterThanOrEqualToFilter("test", new Integer(1));
        } catch (Exception e) {
            fail("no Exception should be throw");
        }
    ...
    public void testbuildLessThanOrEqualToFilter() {
        ...
        try {
            filter = new LessThanOrEqualToFilter("test", new Integer(1));
        } catch (Exception e) {
            fail("no Exception should be throw");
        }
    ...
    public void testbuildBetweenFilter() {
        ...
        try {
            filter = new BetweenFilter("test", new Integer(10), new Integer(10));
        } catch (Exception e) {
            fail("no Exception should be throw");
        }
    ...
    public void testLDAPSearchEqualToFilter() throws Exception {
        ...
        assertTrue("1 person under the filter",
            1 == TestHelper.getItemNumber(it));
    }
    ...
    public void testLDAPSearchOrFilter() throws Exception {
        ...
        assertTrue("2 person under the filter",
            2 == TestHelper.getItemNumber(it));
    }
    ...
    public void testsetSearchStrategy_getSearchStrategy() {
        ...
        assertEquals("The strategy should be the set one before.", strategy,
            ldSearchBundle.getSearchStrategy());
    }
}
