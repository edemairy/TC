...
import com.topcoder.search.builder.hibernate.AndFragmentBuilderHibernateTests;
import com.topcoder.search.builder.hibernate.EqualsFragmentBuilderHibernateTests;
import com.topcoder.search.builder.hibernate.HibernateHelperTests;
import com.topcoder.search.builder.hibernate.HibernateSearchStrategyTests;
import com.topcoder.search.builder.hibernate.InFragmentBuilderHibernateTests;
import com.topcoder.search.builder.hibernate.LikeFragmentBuilderHibernateTests;
import com.topcoder.search.builder.hibernate.NotFragmentBuilderHibernateTests;
import com.topcoder.search.builder.hibernate.NullFragmentBuilderHibernateTests;
import com.topcoder.search.builder.hibernate.OrFragmentBuilderHibernateTests;
import com.topcoder.search.builder.hibernate.RangeFragmentBuilderHibernateTests;
...
public class UnitTests extends TestCase {
    ...
    public static Test suite() {
        ...
        suite.addTestSuite(AndFragmentBuilderHibernateTests.class);
        suite.addTestSuite(EqualsFragmentBuilderHibernateTests.class);
        suite.addTestSuite(InFragmentBuilderHibernateTests.class);
        suite.addTestSuite(LikeFragmentBuilderHibernateTests.class);
        suite.addTestSuite(NotFragmentBuilderHibernateTests.class);
        suite.addTestSuite(NullFragmentBuilderHibernateTests.class);
        suite.addTestSuite(OrFragmentBuilderHibernateTests.class);
        suite.addTestSuite(RangeFragmentBuilderHibernateTests.class);
        suite.addTestSuite(HibernateHelperTests.class);
        suite.addTestSuite(HibernateSearchStrategyTests.class);
