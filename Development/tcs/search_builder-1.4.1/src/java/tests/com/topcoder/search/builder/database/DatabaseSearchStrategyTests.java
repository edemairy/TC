...
public class DatabaseSearchStrategyTests extends TestCase {
    ...
    public void testconstructor_accuracy2() throws Exception {
        assertNotNull("can not construct the DatabaseSearchStrategy.",
            new DatabaseSearchStrategy(connectionFactory, CONNECTIONNAME,
                associations));
    }

    /**
     * The failure test of the constructor. IllegalArgumentException should be thrown.
     *
     * @throws Exception
     *             to JUnit
     */
    ...
    /**
     * The failure test of the constructor. namespace unknown,
    ...
    /**
     * The failure test of the constructor. namespace unknown, IllegalArgumentException
     * should be thrown.
     *
     * @throws Exception
     *             to JUnit
    ...
    /**
     * Test failure test of the method SearchContext, UnrecognizedFilterException will be
     * thrown.
     *
     * @throws Exception
     *             to JUnit
    ...
    public void testbuildSearchContext_failure() throws Exception {
        strategy = new DatabaseSearchStrategy(connectionFactory,
                CONNECTIONNAME, associations);

        try {
            strategy.buildSearchContext(CONTEXT,
                new LessThanFilter("age", new Integer(100)), new ArrayList(),
                aliasMap);
    ...
    public void testsearch_accuracy1() throws Exception {
        ...
        CustomResultSet result = (CustomResultSet) strategy.search(CONTEXT,
                equalToFilter, new ArrayList(), aliasMap);
    ...
    public void testsearch_accuracy3() throws Exception {
        ...
        // search depend the filter
        CustomResultSet result = (CustomResultSet) strategy.search(CONTEXT,
                orFilter, new ArrayList(), aliasMap);
    ...
    public void testsearch_accuracy5() throws Exception {
        ...
        // search depend the filter
        CustomResultSet result = (CustomResultSet) strategy.search(CONTEXT,
                lessThanFilter, new ArrayList(), aliasMap);
    ...
    public void testsearch_accuracy6() throws Exception {
        ...
        assertEquals("There are 5 prople with weight < 31", 5, list.size());
    }
    ...
    public void testsearch_accuracy9() throws Exception {
        BetweenFilter filter = new BetweenFilter("peopleName", "p9", "p1");
    ...
    /**
     * The failure test of search, since the parameters are invalid,
