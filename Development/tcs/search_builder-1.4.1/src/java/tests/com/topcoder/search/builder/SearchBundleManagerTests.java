...
public class SearchBundleManagerTests extends TestCase {
    ...
    /**
     * test fail with construct with wrong namespace. SearchBuilderConfigurationException
     * should be throw
     *
     * @throws Exception
     *             to junit
    ...
    /**
     * test fail with construct with wrong namespace. Since the configuration is invalid,
    ...
    public void testgetSearchBundleNames() {
        ...
        assertEquals("There should 3 SearchBundle in the manager", 4,
            list.size());
    }
    ...
    /**
     * Test the mothed addSearchBundle(fail with exist name). DuplicatedElementsException
     * should throw
     *
     * @throws Exception
     *             to junit
    ...
    public void testaddSearchBundle3() throws Exception {
        ...
        manager.addSearchBundle(new SearchBundle("test", fields, alias,
                "context"));
    ...
    /**
     * test removeSearchBundle with unexist name. no exception should throw
     */
    ...
    public void testsetSearchBundle() {
        ...
        assertEquals("The bundles in SearchBundManager now is updated.", 1,
            manager.getSearchBundleNames().size());
    }

    /**
     * Test the method setSearchBundle(Map), fail for the map is null,
    ...
    /**
     * Test the method setSearchBundle(Map), fail for the map is empty,
     * IllegalArgumentException should be thrown.
     */
