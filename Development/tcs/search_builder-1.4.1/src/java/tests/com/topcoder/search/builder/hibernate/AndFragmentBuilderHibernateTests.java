...
/**
 * <p>
 * Unit test cases for <code>AndFragmentBuilder</code>.
 * </p>
 *
 * @author myxgyy
 * @version 1.4
 */
public class AndFragmentBuilderHibernateTests extends TestCase {
    /**
     * The namespace.
     */
    ...
    protected void setUp() throws Exception {
        ...
        invalid = new EqualToFilter("sb", "2");

        Filter filter2 = new EqualToFilter("The age", "1");
    ...
    /**
     * The failure test of buildSearch, fail for filter not AndFilter,
    ...
    public void testBuildSearch_accuracy() throws Exception {
        ...
        assertEquals("the generated String should be same.",
            "(searchbuild = ? AND p.age = ?)", searchContext.getSearchString().toString());
        assertEquals("two parameters are added.", 2,
            searchContext.getBindableParameters().size());
    }
}
