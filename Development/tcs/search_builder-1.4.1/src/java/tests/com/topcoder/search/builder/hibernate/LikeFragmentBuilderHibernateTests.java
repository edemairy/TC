 ...
 * @version 1.4
 */
public class LikeFragmentBuilderHibernateTests extends TestCase {
    /**
     * The namespace.
     */
    ...
    /**
     * The failure test of buildSearch, fail for filter not LikeFilter,
    ...
    public void testBuildSearch_accuracy() throws Exception {
        ...
        assertEquals("the generated String should be same.",
            "sn LIKE ? ESCAPE ?", searchContext.getSearchString().toString());
    }
}
