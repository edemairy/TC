 ...
 * @version 1.4
 */
public class EqualsFragmentBuilderHibernateTests extends TestCase {
    /**
     * The namespace.
     */
    ...
    /**
     * The failure test of buildSearch, fail for filter not EqualToFilter,
    ...
    public void testBuildSearch_accuracy() throws Exception {
        ...
        assertEquals("the generated String should be same.", "searchbuild = ?",
