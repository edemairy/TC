...
public class ValidationResult {
    ...
    private ValidationResult(boolean isValid, String message, Filter filter) {
        if ((message != null) && (message.length() == 0)) {
            throw new IllegalArgumentException(
                "The message should not empty to construct ValidationResult.");
        }
     ...
     */
    public static synchronized ValidationResult createInvalidResult(
        String message, Filter filter) {
        if (message == null) {
            throw new IllegalArgumentException(
        ...
        if (filter == null) {
            throw new IllegalArgumentException(
                "The filter should not be null to createInvalidResult.");
        }

        if (message.length() == 0) {
            throw new IllegalArgumentException(
                "The message should not be empty to createInvalidResult.");
        }
