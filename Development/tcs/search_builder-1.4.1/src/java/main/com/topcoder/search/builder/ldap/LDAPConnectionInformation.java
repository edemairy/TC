...
public class LDAPConnectionInformation {
    ...
    /**
     * It will hold a boolean indicating the connection is secure or not. If it is true, a
     * ssl connection should be created. Otherwise a regular connection should be created.
     */
    ...
    /**
     * <p>
     * Create a new instance by setting all the members in the class.
     * </p>
     *
     * @param factory
     *            a LDAPSDK object used to create a LDAP connection
     * @param host
     *            host name
     * @param port
     *            port number of the host
     * @param isSecure
     *            a boolean indicating whether we need to create a ssl connection or
     *            regular connection
     * @param scope
     *            the search scope
     * @param dnroot
     *            the dnroot(user) to bind the ldapserver it can be null or empyt,denote
     *            anonymous search.
     * @param password
     *            the password to bind the ldapserver it can be null or empyt,denote
     *            anonymous search.
     * @throws IllegalArgumentException
     *             if any parameter is Null or the host is an empty string, or port has 0
    ...
    /**
     * <p>
     * Create a new instance via the properties. The properties should include all the
     * members the class required. Also the mothed check the members in the properties
     * whether they are valid.
     * </p>
     *
     * @param properties
     *            Property used to construct the instance
     * @throws IllegalArgumentException
     *             if param is null
     * @throws IllegalArgumentException
     *             if any member in the properties is illegal
     */
    ...
    /**
     * <p>
     * get the factory object used to create a LDAP connection.
     * </p>
    ...
    /**
     * <p>
     * get a boolean indicating whether we need to create a ssl connection or regular
     * connection.
     * </p>
     *
     * @return a boolean indicating whether we need to create a ssl connection or regular
     *         connection
     */
