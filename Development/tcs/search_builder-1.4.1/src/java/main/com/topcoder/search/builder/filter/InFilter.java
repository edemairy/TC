...
/**
 * <p>
 * This class is a concrete implementor of the Filter interface. It is used to construct
 * IN search criterion.
 * </p>
 * <p>
...
public class InFilter implements Filter {
    ...
    /**
     * <p>
     * Create a new instance,by setting the name and value list.
     * </p>
     *
     * @param name
     *            the filed name of the search criterion
     * @param values
     *            a List of Comparable objects
     * @throws IllegalArgumentException
     *             if any parameter is Null or the items in the list is null
     * @throws IllegalArgumentException
    ...
    /**
     * <p>
     * Test to see if the filter is valid according to the rules presented in the
     * validators.
     * </p>
     *
     * @param validators
     ...
     * @throws IllegalArgumentException
     *             if any parameter is Null or the keys and values in map is null
     * @throws IllegalArgumentException
     *             if any parameter is empty
     */
