 ...
 * in which all the SearchBundles are loaded from the configuration.
 * </p>
 *
...
public class SearchBundleManager {
     ...
     * And all the searchBundles in the configuration are loaded from the configuration
     ...
     */
    public SearchBundleManager(String namespace)
        throws SearchBuilderConfigurationException {
        if (namespace == null) {
            throw new IllegalArgumentException(
                "The namespace should not be null to construct SearchBundleManager.");
        }

        if (namespace.trim().length() == 0) {
            throw new IllegalArgumentException(
                "The namespace should not be empty to construct SearchBundleManager.");
        }
        ...
        Property searchBundles = SearchBuilderHelper.getConfigPropertyObject(namespace,
                "searchBundles", false);
        ...
        for (Iterator it = subs.iterator(); it.hasNext();) {
            ...
            SearchStrategy searchStrategy = getSearchStrategy(searchBundle,
                    strategyFactory);
            ...
            if ((context == null) || (context.trim().length() == 0)) {
                throw new SearchBuilderConfigurationException(
                    "The context should not be missing.");
            }
            ...
            try {
                ...
                bundle = new SearchBundle(name, searchFields, alias, context,
                        searchStrategy);
            } catch (IllegalArgumentException e) {
                throw new SearchBuilderConfigurationException("failed to create the SearchBundle.",
                    e);
            }
     ...
     */
    private static SearchStrategy getSearchStrategy(Property property,
        ObjectFactory factory) throws SearchBuilderConfigurationException {
        String key = property.getValue("searchStrategy.class");

        //the class is required
        if ((key == null) || (key.trim().length() == 0)) {
            throw new SearchBuilderConfigurationException(
                "Property 'searchStrategy.class' is missing for validator.");
        }
        ...
        try {
            ...
            throw new SearchBuilderConfigurationException("can not create the SearchStrategy.",
                e);
        }
    }
     ...
     */
    private static Map getFields(Property property, ObjectFactory factory)
        throws SearchBuilderConfigurationException {
        Map map = new HashMap();
        ...
        if (fields == null) {
            throw new SearchBuilderConfigurationException(
                "The 'searchableFields' should not be missed.");
        }
        ...
        for (Iterator it = fieldList.iterator(); it.hasNext();) {
            ...
            if ((key == null) || (key.trim().length() == 0)) {
                throw new SearchBuilderConfigurationException(
                    "Property 'class' is missing for validator.");
            }
            ...
            try {
                ...
                throw new SearchBuilderConfigurationException("faliled to create validator.",
                    e);
            }
        }
     ...
     */
    private static Map getAlias(Property property)
        throws SearchBuilderConfigurationException {
        Map map = new HashMap();
    ...
    public synchronized SearchBundle getSearchBundle(String name) {
        if (name == null) {
            throw new IllegalArgumentException(
                "The name should not be null to getSearchBundle.");
        }

        if (name.trim().length() == 0) {
            throw new IllegalArgumentException(
                "The name should not be empty to getSearchBundle.");
        }
     ...
     */
    public synchronized void addSearchBundle(SearchBundle searchBundle)
        throws DuplicatedElementsException {
        if (searchBundle == null) {
            throw new IllegalArgumentException(
                "The searchBundle should not be null to addSearchBundle.");
        }

        String searchBundleName = searchBundle.getName();

        if (searchBundleMap.containsKey(searchBundleName)) {
            throw new DuplicatedElementsException("The SearchBundle with name:" +
                searchBundleName + " already exist while do addSearchBundle.");
        }
    ...
    public synchronized void removeSearchBundle(String name) {
        if (name == null) {
            throw new IllegalArgumentException(
                "The name should not be null to removeSearchBundle.");
        }

        if (name.length() == 0) {
            throw new IllegalArgumentException(
                "The name should not be empty to removeSearchBundle.");
        }
    ...
    public synchronized void setSearchBundle(Map searchBundleMap) {
        SearchBuilderHelper.checkSearchBundleMap(searchBundleMap,
            "searchBundleMap");
