...
public class HibernateSearchStrategy implements SearchStrategy {
    ...
    public HibernateSearchStrategy(String namespace)
        ...
        try {
            this.sessionFactory = (filePath == null)
                ...
                : new Configuration().configure(filePath).buildSessionFactory();
     ...
     * @param fragmentBuilders
     *            The ClassAssociator to use for this class.
     * @param sessionFactoryJndiName
     *            The JNDI lookup name for the SessionFactory to set for this class.
     * @throws SearchBuilderConfigurationException 
     *            if a SessionFactory is not configured under JNDI for the given.
     * @throws IllegalArgumentException
     *            If either parameter is null.
     */
    public HibernateSearchStrategy(String sessionFactoryJndiName,
        ClassAssociator fragmentBuilders) throws SearchBuilderConfigurationException {
        if (sessionFactoryJndiName == null) {
            throw new IllegalArgumentException(
                "The sessionFactoryJndiName should not be null.");
        }
        if (fragmentBuilders == null) {
            throw new IllegalArgumentException(
                "The fragmentBuilders should not be null.");
        ...
        try {
            ...
            if (sessionFactory == null) {
                throw new SearchBuilderConfigurationException("The sessionFactory under context name " +
                        sessionFactoryJndiName + " should not be null."); 
            }
        } catch (NamingException e) {
            throw new SearchBuilderConfigurationException("A NamingException occurred.",
                    e);
        } catch (ClassCastException e) {
                throw new SearchBuilderConfigurationException(
                    "The object under context name " + sessionFactoryJndiName + " is not type of SessionFactory.", e);
        }
