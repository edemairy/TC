...
ALTER TABLE person
        ...
        REFERENCES company(id) CONSTRAINT FK_person_company);
        
INSERT INTO company VALUES (1, 'Google');
INSERT INTO company VALUES (2, 'Microsoft');
INSERT INTO company VALUES (3, 'Yahoo');

INSERT INTO person VALUES (1, 'Petr', 23, 'Male', 1);
INSERT INTO person VALUES (2, 'CodeDoc', 53, 'Male', 2);
INSERT INTO person VALUES (3, 'Anita', 23, 'Female', 3);