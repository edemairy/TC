...
/**
 * <p>
 * The BigDecimalConverter class handles on demand conversions from the BigDecimal type to various other data
 * types. It implements the OnDemandConverter interface and has no state.
 * </p>
 * <p>
 * When a value is converted by BigDecimalConverter, the condition that the value can be converted is: value
 * is a BigDecimal and is not null, and desiredType is Byte, Short, Integer, Long, Float, Double, or String.
 * </p>
 * <p>
...
public class BigDecimalConverter implements OnDemandConverter {
     ...
     * value is a BigDecimal and is not null, and desiredType is Byte, Short, Integer, Long, Float, Double, or
     * String.
     * </p>
     *
    ...
    /**
     * <p>
     * Converts value into an instance of desiredType. If value is BigDecimal and not null, and desiredType is
     * Byte, Short, Integer, Long, Float, Double and String, value is converted to the corresponding type and
     * returned.
     * </p>
     *
    ...
    public Object convert(Object value, int column, CustomResultSetMetaData metaData, Class desiredType)
        ...
        if (!canConvert(value, column, metaData, desiredType)) {
            throw new IllegalMappingException("value can't be converted to the desired type -- "
                + desiredType + " -- by BigDecimalConverter.");
        }
