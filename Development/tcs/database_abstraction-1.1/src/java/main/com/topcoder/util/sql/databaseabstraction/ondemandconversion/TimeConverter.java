...
/**
 * <p>
 * The TimeConverter class handles on demand conversions from the Time type to various other data types. It
 * implements the OnDemandConverter interface and has no state.
 * </p>
 * <p>
 * When a value is converted by TimeConverter, the condition that value can be converted is: value is not a
 * Time or is null, and desiredType is Timestamp, Date, Long, or String.
 * </p>
 * <p>
...
public class TimeConverter implements OnDemandConverter {
    ...
    /**
     * The format used when converting the Time to a string. This field is set in the constructor and is
     * immutable. It can never be null.
     */
    private final DateFormat dateFormat;

    /**
     * Create a new TimeConverter. date format used is initialized to default SimpleDateFormat.
     */
     ...
     * value is not a Time or is null, and desiredType is Timestamp, Date, Long, or String.
     * </p>
     *
    ...
    /**
     * <p>
     * Converts value into an instance of desiredType. If value is not a Time or is null, and desiredType is
     * Timestamp, Date, Long, or String,value is converted to the corresponding type and returned(specially,
