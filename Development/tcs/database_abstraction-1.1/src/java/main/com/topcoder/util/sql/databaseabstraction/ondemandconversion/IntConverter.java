...
/**
 * <p>
 * The IntConverter class handles on demand conversions from the Integer type to various other data types. It
 * implements the OnDemandConverter interface and has no state.
 * </p>
 * <p>
 * When a value is converted by IntConverter, the condition that value can be converted is: value is a Integer
 * and not null, false, and desiredType is Byte, Short, BigDecimal, Long, Float, Double, or String.
 * </p>
 * <p>
...
public class IntConverter implements OnDemandConverter {
     ...
     * value is a Integer and not null, false, and desiredType is Byte, Short, BigDecimal, Long, Float,
     * Double, or String.
     * </p>
     *
    ...
    /**
     * <p>
     * Converts value into an instance of desiredType.If value is a Integer and not null, false, and
     * desiredType is Byte, Short, BigDecimal, Long, Float, Double, or String, value is converted to the
