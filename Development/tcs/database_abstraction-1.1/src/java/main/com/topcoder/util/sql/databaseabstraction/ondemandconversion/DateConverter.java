...
/**
 * <p>
 * The DateConverter class handles on demand conversions from the Date type to various other data types. It
 * implements the OnDemandConverter interface and has no state.
 * </p>
 * <p>
 * When a value is converted by DateConverter, the condition that value can be converted is: value is a
 * Date and is not null, and desiredType is Timestamp, Time, Long, or String.
 * </p>
 * <p>
...
public class DateConverter implements OnDemandConverter {
    ...
    /**
     * The format used when converting the Date to a string. This field is set in the constructor and is
     * immutable. It can never be null.
     */
    private final DateFormat dateFormat;

    /**
     * Create a new DateConverter. date format used is initialized to default SimpleDateFormat.
     */
     ...
     *
     * @param dateFormat The format to use for writing dates
     ...
     * value is a Date and is not null, and desiredType is Timestamp, Time, Long, or String.
     * </p>
     *
     ...
     * @throws IllegalArgumentException If metaData or desiredType is null or column <= 0 or > column count of
     *             metadata.
     */
    ...
    /**
     * <p>
     * Converts value into an instance of desiredType. If value is a Date and is not null, and desiredType is
     * Timestamp, Time, Long, or String, value is converted to the corresponding type and returned(specially,
     * String value will be formatted using the date format initialized in constructor).
     * </p>
     *
