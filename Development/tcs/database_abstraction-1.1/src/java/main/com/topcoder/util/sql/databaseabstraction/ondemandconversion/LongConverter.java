...
/**
 * <p>
 * The LongConverter class handles on demand conversions from the Long type to various other data types. It
 * implements the OnDemandConverter interface and has no state.
 * </p>
 * <p>
 * When a value is converted by LongConverter, the condition that value can be converted is: value is a Long
 * and not null, and desiredType is Byte, Short, Integer, BigDecimal, Float, Double, Date, Time, Timestamp, or
 * String.
 * </p>
 * <p>
...
public class LongConverter implements OnDemandConverter {
     ...
     * value is a Long and not null, and desiredType is Byte, Short, Integer, BigDecimal, Float, Double, Date,
    ...
    public boolean canConvert(Object value, int column, CustomResultSetMetaData metaData, Class desiredType) {
        ...
        return AbstractionHelper.canConvert(value, Long.class, desiredType, new Class[] {Byte.class,
            Short.class, Integer.class, BigDecimal.class, Float.class, Double.class, Date.class, Time.class,
    ...
    /**
     * <p>
     * Converts value into an instance of desiredType.If value is a Long and not null, and desiredType is
     * Byte, Short, Integer, BigDecimal, Float, Double, Date, Time, Timestamp, or String, value is converted
     * to the corresponding type and returned.
     * </p>
     *
