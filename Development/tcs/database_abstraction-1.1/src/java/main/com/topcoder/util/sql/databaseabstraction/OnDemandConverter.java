...
/**
 * <p>
 * The OnDemandConverter interface is the counterpart of the Converter interface, updated to allow for version
 * 1.1. on-demand conversion. In order to support this, the conversion method takes in an extra parameter, the
 * desired returned type. This interface also exposes a method to determine whether a conversion can be done.
 * </p>
 * <p>
 * This interface makes no thread-safety or mutability requirements.
 * </p>
 *
...
public interface OnDemandConverter {
    /**
     * <p>
     * Determines whether this converter can convert the given input object into an instance of desiredType
     * (or implementation of, if desiredType is an interface). If this method returns true, then a call to
     * convert with the same arguments should always succeed.
     * </p>
     *
     ...
     * @param desiredType The type that we want to determine if conversion is capable for
     * @return True if the converter can make the conversion, false otherwise.
     * @throws IllegalArgumentException If metaData or desiredType argument is null
     */
     ...
     * interface). The return value from this function should always be of the type desiredType (or a subclass
     * or an interface implementation, depending on whether desiredType represents a class or an interface).
     * </p>
     *
     * @param value The object we want to convert (may be null)
     * @param column The index of the column that the value is in the CustomResultSet. This can be used to
