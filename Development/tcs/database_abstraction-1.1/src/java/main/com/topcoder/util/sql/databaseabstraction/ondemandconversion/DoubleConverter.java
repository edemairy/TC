...
/**
 * <p>
 * The DoubleConverter class handles on demand conversions from the Double type to various other data types.
 * It implements the OnDemandConverter interface and has no state.
 * </p>
 * <p>
 * When a value is converted by DoubleConverter, the condition that value can be converted is: value is a
 * Double and not null, and desiredType is Byte, Short, Integer, Long, Float, BigDecimal, or String.
 * </p>
 * <p>
...
public class DoubleConverter implements OnDemandConverter {
     ...
     * value is a Double and not null, and desiredType is Byte, Short, Integer, Long, Float, BigDecimal, or
     * String.
     * </p>
     *
    ...
    public boolean canConvert(Object value, int column, CustomResultSetMetaData metaData, Class desiredType) {
        ...
        return AbstractionHelper.canConvert(value, Double.class, desiredType, new Class[] {Byte.class,
            Short.class, Integer.class, Long.class, Float.class, BigDecimal.class, String.class});
    }

    /**
     * <p>
     * Converts value into an instance of desiredType. If value is a Double and not null, and desiredType is
     * Byte, Short, Integer, Long, Float, BigDecimal, or String, value is converted to the corresponding type
     * and returned
     * </p>
     *
    ...
    public Object convert(Object value, int column, CustomResultSetMetaData metaData, Class desiredType)
        ...
        if (!canConvert(value, column, metaData, desiredType)) {
            throw new IllegalMappingException("value can't be converted to the desired type -- "
                + desiredType + " -- by DoubleConverter.");
        }
