...
/**
 * <p>
 * The FloatConverter class handles on demand conversions from the Float type to various other data types. It
 * implements the OnDemandConverter interface and has no state.
 * </p>
 * <p>
 * When a value is converted by FloatConverter, the condition that value can be converted is: value is a Float
 * and is not null, and desiredType is Byte, Short, Integer, Long, BigDecimal, Double, or String.
 * </p>
 * <p>
...
public class FloatConverter implements OnDemandConverter {
     ...
     * value is a Float and is not null, and desiredType is Byte, Short, Integer, Long, BigDecimal, Double, or
     * String.
     * </p>
     *
    ...
    public boolean canConvert(Object value, int column, CustomResultSetMetaData metaData, Class desiredType) {
        ...
        return AbstractionHelper.canConvert(value, Float.class, desiredType, new Class[] {Byte.class,
            Short.class, Integer.class, Long.class, Double.class, BigDecimal.class, String.class});
    }

    /**
     * <p>
     * Converts value into an instance of desiredType. If value is a Float and is not null, and desiredType is
     * Byte, Short, Integer, Long, BigDecimal, Double, or String, value is converted to the corresponding type
     * and returned.
     * </p>
     *
