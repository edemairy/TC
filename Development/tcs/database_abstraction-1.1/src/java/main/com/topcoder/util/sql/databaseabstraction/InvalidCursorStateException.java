...
/**
 * <p>
 * The InvalidCursorStateException is thrown by a CustomResultSet to indicate that it is not currently
 * positioned on any row. This could be because it is positioned before the first row or after the last row.
 * </p>
 * <p>
 * This exception is thrown by CustomResultSet in the getXXX methods when data can not be retrieved because of
 * the current row position of the CustomResultSet.
 * </p>
 *
