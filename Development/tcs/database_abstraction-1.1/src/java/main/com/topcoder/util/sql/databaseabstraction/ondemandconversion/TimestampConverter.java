...
/**
 * <p>
 * The TimestampConverter class handles on demand conversions from the Timestamp type to various other data
 * types. It implements the OnDemandConverter interface and has no state.
 * </p>
 * <p>
 * When a value is converted by TimestampConverter, the condition that value can be converted is: value is a
 * Timestamp and not null, and desiredType is Date, Time, Long, or String.
 * </p>
 * <p>
...
public class TimestampConverter implements OnDemandConverter {
    ...
    /**
     * The format used when converting the Timestamp to a string. This field is set in the constructor and is
     * immutable. It can never be null.
     */
    private final DateFormat dateFormat;

    /**
     * Create a new TimeStampConverter. date format used is initialized to default SimpleDateFormat.
     */
     ...
     *
     * @param dateFormat The format to use when converting to a string
     ...
     * is a Timestamp and not null, and desiredType is Date, Time, Long, or String.
     * </p>
     *
    ...
    /**
     * <p>
     * Converts value into an instance of desiredType.If value is a Timestamp and not null, and desiredType is
     * Date, Time, Long, or String, value is converted to the corresponding type and returned(specially,
    ...
    public Object convert(Object value, int column, CustomResultSetMetaData metaData, Class desiredType)
        ...
        if (!canConvert(value, column, metaData, desiredType)) {
            throw new IllegalMappingException("value can't be converted to the desired type -- "
                + desiredType + " -- by TimestampConverter.");
        }
