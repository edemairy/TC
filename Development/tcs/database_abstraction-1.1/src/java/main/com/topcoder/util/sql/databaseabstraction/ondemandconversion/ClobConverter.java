...
/**
 * <p>
 * The ClobConverter class handles on demand conversions from the Clob type to various other data types. It
 * implements the OnDemandConverter interface and has no state.
 * </p>
 * <p>
 * When a value is converted by ClobConverter, the condition that value can be converted is: value is a Clob
 * and not null, and desiredType is java.io.Reader, java.io.InputStream, or String.
 * </p>
 * <p>
...
public class ClobConverter implements OnDemandConverter {
     ...
     * value is a Clob and not null, and desiredType is java.io.Reader, java.io.InputStream, or String.
     * </p>
     *
    ...
    /**
     * <p>
     * Converts value into an instance of desiredType. If value is a Clob and not null, and desiredType is
     * java.io.Reader, java.io.InputStream, or String, value is converted to the corresponding type and
     * returned.
     * </p>
     *
     ...
     *             count of metadata
     * @throws IllegalMappingException If the conversion can not be made (if either of the Clob calls results
     *             in a SQL exception)
     */
    public Object convert(Object value, int column, CustomResultSetMetaData metaData, Class desiredType)
        ...
        try {
            ...
            if (desiredType.isAssignableFrom(InputStream.class)) {
                ...
                return clobValue.getSubString((long) 1, (int) clobValue.length());
            }
