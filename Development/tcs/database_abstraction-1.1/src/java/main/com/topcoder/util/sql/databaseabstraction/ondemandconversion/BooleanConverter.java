...
/**
 * <p>
 * The BooleanConverter class handles on demand conversions from the Boolean type to various other data types.
 * It implements the OnDemandConverter interface and has no state.
 * </p>
 * <p>
 * When a value is converted by BooleanConverter, the condition that value can be converted is: value is a
 * Boolean and is not null, and desiredType is Byte, Short, Integer, Long, Float, Double, BigDecimal, or
 * String.
 * </p>
 * <p>
...
public class BooleanConverter implements OnDemandConverter {
     ...
     * value is a Boolean and is not null, and desiredType is Byte, Short, Integer, Long, Float, Double,
    ...
    public boolean canConvert(Object value, int column, CustomResultSetMetaData metaData, Class desiredType) {
        ...
        return AbstractionHelper.canConvert(value, Boolean.class, desiredType,
    ...
    /**
     * <p>
     * Converts value into an instance of desiredType. If value is a Boolean and is not null, and desiredType
     * is Byte, Short, Integer, Long, Float, Double, BigDecimal, or String, value is converted to the
    ...
    public Object convert(Object value, int column, CustomResultSetMetaData metaData, Class desiredType)
        ...
        if (!canConvert(value, column, metaData, desiredType)) {
            throw new IllegalMappingException("value can't be converted to the desired type -- "
                + desiredType + " -- by BooleanConverter.");
        }
