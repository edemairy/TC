 ...
 * @since 1.1
 */
public class TimestampConverterTestV11 extends TestCase {
    ...
    public void testCanConvert8() {
        assertEquals("canConvert is incorrect.", converter.canConvert(TEST_VALUE, 1, TEST_CRSMD, Time.class),
            true);
    }
