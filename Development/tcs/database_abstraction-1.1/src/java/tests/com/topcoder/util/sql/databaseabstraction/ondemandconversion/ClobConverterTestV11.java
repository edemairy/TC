 ...
 * @since 1.1
 */
public class ClobConverterTestV11 extends TestCase {
    ...
    /**
     * Initialize instance of Clob.This will get database connection, which is not closed here.
     *
    ...
    public void testCanConvert6() {
        assertEquals("canConvert is incorrect.", converter.canConvert(null, 1, TEST_CRSMD, String.class),
            false);
    }
    ...
    public void testCanConvert7() {
        assertEquals("canConvert is incorrect.", converter.canConvert(new String("Not Clob"), 1, TEST_CRSMD,
            String.class), false);
    }
    ...
    public void testCanConvert8() {
        assertEquals("canConvert is incorrect.", converter.canConvert(testValue, 1, TEST_CRSMD, Date.class),
            false);
    }
    ...
    public void testCanConvert9() {
        assertEquals("canConvert is incorrect.", converter.canConvert(testValue, 1, TEST_CRSMD,
            InputStream.class), true);
    }
    ...
    public void testCanConvert10() {
        assertEquals("canConvert is incorrect.",
            converter.canConvert(testValue, 1, TEST_CRSMD, Reader.class), true);
    }
    ...
    public void testCanConvert11() {
        assertEquals("canConvert is incorrect.",
            converter.canConvert(testValue, 1, TEST_CRSMD, String.class), true);
    }
     ...
     * </p>
     * <p>
     * Verify:When desiredType is InputStream, IllegalMappingException is thrown.
     * </p>
     *
     * @throws Exception exception to JUnit.
     */
