 ...
 * @since 1.1
 */
public class ByteConverterTestV11 extends TestCase {
    ...
    public void testCanConvert7() {
        assertEquals("canConvert is incorrect.", converter.canConvert(new String("Not BigDecimal"), 1,
    ...
    public void testCanConvert16() {
        assertEquals("canConvert is incorrect.", converter
            .canConvert(TEST_VALUE, 1, TEST_CRSMD, String.class), true);
    }
