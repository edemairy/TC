...
/**
 * <p>
 * This tests CustomResultSet data types.
 * </p>
 *
 ...
 * @since 1.0
 */
public class ResultSetDataTypeTestCase extends TestCase {
            ...
            for (;;) {
                ...
                for (int i = 1; i <= n; ++i) {
                    ...
                    if (className.equals("Array")) {
                        ...
                        assertTrue(crs.getBoolean(columnIndex) == ((Boolean) crs.getObject(columnIndex))
                            .booleanValue());
                        assertTrue(crs.getBoolean(columnName) == ((Boolean) crs.getObject(columnName))
                            .booleanValue());
                    } else if (className.equals("Byte")) {
                        assertTrue(crs.getByte(columnIndex) == ((Byte) crs.getObject(columnIndex))
                            .byteValue());
                        ...
                        assertTrue(crs.getDouble(columnIndex) == ((Double) crs.getObject(columnIndex))
                            .doubleValue());
                        assertTrue(crs.getDouble(columnName) == ((Double) crs.getObject(columnName))
                            .doubleValue());
                    } else if (className.equals("Float")) {
                        assertTrue(crs.getFloat(columnIndex) == ((Float) crs.getObject(columnIndex))
                            .floatValue());
                        assertTrue(crs.getFloat(columnName) == ((Float) crs.getObject(columnName))
                            .floatValue());
                    } else if (className.equals("Integer")) {
                        assertTrue(crs.getInt(columnIndex) == ((Integer) crs.getObject(columnIndex))
                            .intValue());
                        assertTrue(crs.getInt(columnName) == ((Integer) crs.getObject(columnName)).intValue());
                    } else if (className.equals("Long")) {
                        assertTrue(crs.getLong(columnIndex) == ((Long) crs.getObject(columnIndex))
                            .longValue());
                        ...
                        assertTrue(crs.getShort(columnIndex) == ((Short) crs.getObject(columnIndex))
                            .shortValue());
                        assertTrue(crs.getShort(columnName) == ((Short) crs.getObject(columnName))
                            .shortValue());
