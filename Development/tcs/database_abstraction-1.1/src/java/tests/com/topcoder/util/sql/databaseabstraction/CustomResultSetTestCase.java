 ...
 * @since 1.0
 */
public class CustomResultSetTestCase extends TestCase {
    ...
    public void testCustomResultSetSort() {
        try {
            ...
            crs.sortAscending(3, new Comparator() {
            ...
            crs.sortAscending("D_Text_To_Number", new Comparator() {
                public int compare(Object a, Object b) {
                    return ((String) a).compareTo((String) b);
                }
            });
            ...
            crs.sortDescending(3, new Comparator() {
                public int compare(Object a, Object b) {
                    return ((String) a).compareTo((String) b);
                }
            });
            ...
            crs.sortDescending("D_Text_To_Number", new Comparator() {
                public int compare(Object a, Object b) {
                    return ((String) a).compareTo((String) b);
                }
            });
            ...
            crs.sortAscending(new int[] {2, 3}, new Comparator[] {null, new Comparator() {
                public int compare(Object a, Object b) {
                    return ((String) a).compareTo((String) b);
                }
            } });
            ...
            crs.sortDescending(new int[] {2, 3}, new Comparator[] {null, new Comparator() {
                public int compare(Object a, Object b) {
                    return ((String) a).compareTo((String) b);
                }
            } });
