...
/**
 * Test case for OnDemandMapper.
 *
 * @author justforplay
 * @version 1.1
 * @since 1.1
 */
public class OnDemandMapperTestV11 extends TestCase {
     ...
     * </p>
     * <p>
     * Verify: When converters contains null element, IllegalArgumentException is thrown.
     * </p>
     */
    ...
    public void testCanConvert3() {
        assertFalse("canConvert is incorrect.", mapper.canConvert(new BigDecimal("100"), 1, TEST_CRSMD,
            Integer.class));
    }
    ...
    public void testCanConvert4() {
        ...
        assertFalse("canConvert is incorrect.", mapper.canConvert(new Long("100"), 1, TEST_CRSMD,
            Integer.class));
    }
    ...
    public void testCanConvert5() {
        try {
            mapper.addConverter(new BigDecimalConverter());
            assertFalse("canConvert is incorrect.", mapper.canConvert(new BigDecimal("100"), 0, TEST_CRSMD,
                Integer.class));
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // good
    ...
    public void testCanConverter6() {
        try {
            mapper.addConverter(new BigDecimalConverter());
            assertFalse("canConvert is incorrect.", mapper.canConvert(new BigDecimal("100"), TEST_CRSMD
                .getColumnCount() + 1, TEST_CRSMD, Integer.class));
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // good
        }
    ...
    public void testCanConverter7() {
        mapper.addConverter(new BigDecimalConverter());
        assertTrue("canConvert is incorrect.", mapper.canConvert(new BigDecimal("100"), 1, TEST_CRSMD,
            Integer.class));
    }
    ...
    /**
     * <p>
     * Test convert(Object value, int column, CustomResultSetMetaData metaData, Class desiredType).
     * </p>
     * <p>
     * Verify: When metaData is null, IllegalArgumentException is thrown.
     * </p>
    ...
    public void testCreateDefaultOnDemandMapper() {
        ...
        OnDemandConverter[] real = mapper2.getConverters();
        assertEquals("createDefaultOnDemandMapper is incorrect.", real.length, 15);
        Class[] expected = new Class[] {BigDecimalConverter.class, BlobConverter.class,
            BooleanConverter.class, ByteArrayConverter.class, ByteConverter.class, ClobConverter.class,
            DateConverter.class, DoubleConverter.class, FloatConverter.class, IntConverter.class,
            LongConverter.class, ShortConverter.class, StringConverter.class, TimeConverter.class,
