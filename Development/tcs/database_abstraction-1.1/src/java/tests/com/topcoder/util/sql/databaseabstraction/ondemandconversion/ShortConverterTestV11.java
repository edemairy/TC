 ...
 * @since 1.1
 */
public class ShortConverterTestV11 extends TestCase {
    ...
    public void testCanConvert8() {
        assertEquals("canConvert is incorrect.", converter.canConvert(TEST_VALUE, 1, TEST_CRSMD, Date.class),
            false);
    }
    ...
    public void testCanConvert10() {
        assertEquals("canConvert is incorrect.",
            converter.canConvert(TEST_VALUE, 1, TEST_CRSMD, Short.class), false);
    }
