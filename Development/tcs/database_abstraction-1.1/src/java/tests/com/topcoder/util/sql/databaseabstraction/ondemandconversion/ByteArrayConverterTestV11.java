 ...
 * @since 1.1
 */
public class ByteArrayConverterTestV11 extends TestCase {
    ...
    public void testCanConvert7() {
        assertEquals("canConvert is incorrect.", converter.canConvert(new String("Not byte[]"), 1,
    ...
    public void testCanConvert10() {
        assertEquals("canConvert is incorrect.", converter
            .canConvert(TEST_VALUE, 1, TEST_CRSMD, String.class), false);
    }
    ...
    public void testCanConvert11_1() {
        assertEquals("canConvert is incorrect.", converter
            .canConvert(TEST_VALUE, 1, TEST_CRSMD, byte[].class), false);
    }
