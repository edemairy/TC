 ...
 * @since 1.1
 */
public class BlobConverterTestV11 extends TestCase {
    ...
    /**
     * Initialize instance of Blob.This will get database connection, which is not closed here.
     *
    ...
    public void testCanConvert6() {
        assertEquals("canConvert is incorrect.", converter.canConvert(null, 1, TEST_CRSMD, byte[].class),
            false);
    }
    ...
    public void testCanConvert7() {
        assertEquals("canConvert is incorrect.", converter.canConvert(new String("Not Blob"), 1, TEST_CRSMD,
            byte[].class), false);
    }
    ...
    public void testCanConvert10() {
        assertEquals("canConvert is incorrect.",
            converter.canConvert(testValue, 1, TEST_CRSMD, byte[].class), true);
    }
