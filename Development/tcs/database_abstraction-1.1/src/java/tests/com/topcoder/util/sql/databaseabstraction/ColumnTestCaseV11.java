 ...
 * @since 1.1
 */
public class ColumnTestCaseV11 extends TestCase {
    ...
    /**
     * <p>
     * Test Constructor Column(String, int, String, int, String, int, int, boolean, boolean, boolean).
     * </p>
     * <p>
    ...
    public void testColumn() {
        ...
        assertEquals("columnClassName is not initialized correctly.", column.getColumnClassName(),
            "className");
    ...
    /**
     * <p>
     * Test Constructor Column(String, int, String, int, String, int, int, boolean, boolean, boolean,String).
     * </p>
     * <p>
     * Verify:Column can be instantiated correctly.
     * </p>
    ...
    public void testColumn2() {
        Column column2 = new Column("className", 5, "label", 4, "typeName", 2, 3, true, false, true,
            "columnName");
    ...
    public void testGetColumnClassName() {
        assertEquals("columnClassName can not be retrieved correctly.", column.getColumnClassName(),
            "className");
    }
