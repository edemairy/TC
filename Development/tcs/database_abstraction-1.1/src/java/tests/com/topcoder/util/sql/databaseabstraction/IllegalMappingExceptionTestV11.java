 ...
 * @since 1.1
 */
public class IllegalMappingExceptionTestV11 extends TestCase {
    /**
     * <p>
    ...
    public void testIllegalMappingException2() {
        ...
        assertNotNull("Unable to instantiated IllegalMappingException.", exception);
        assertEquals("IllegalMappingException.message is initialized correctly.", exception.getMessage(),
            "TEST");
    }

    /**
     * <p>
     * Test constructor IllegalMappingException(String message, Exception cause).
     * </p>
     * <p>
     * Verify: IllegalMappingException can be instantiated correctly.
     * </p>
    ...
    public void testIllegalMappingException3() {
        ...
        assertNotNull("Unable to instantiated IllegalMappingException.", exception);
        assertEquals("IllegalMappingException.message is not initialized correctly.", exception
            .getMessage(), "TEST");
        assertEquals("IllegalMappingException.cause is not initialized correctly.", exception.getCause(),
            nullException);
    }
