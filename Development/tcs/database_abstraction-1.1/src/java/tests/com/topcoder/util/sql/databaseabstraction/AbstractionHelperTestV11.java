...
/**
 * Test case for AbstractionHelper.
 *
 * @author justforplay
 * @version 1.1
 * @since 1.1
 */
public class AbstractionHelperTestV11 extends TestCase {
     ...
     * </p>
     * <p>
     * Verify: error message of IllegalArgumentException contains necessary information.
     * </p>
     */
     ...
     * </p>
     * <p>
     * Verify:When arg contains null element, IllegalArgumentException is thrown.
     * </p>
     */
    ...
    /**
     * <p>
     * Test canConvert(Object value,Class orgClass, Class desiredType,Class[] canConvertTo)).
     * </p>
     * <p>
    ...
    public void testCanConvert1() {
        assertFalse("canConvert is incorrect.", AbstractionHelper.canConvert(null, String.class, Long.class,
            new Class[] {}));
    }
    ...
    public void testCanConvert2() {
        assertFalse("canConvert is incorrect.", AbstractionHelper.canConvert(new Long(100), String.class,
            Long.class, new Class[] {}));
    }
     ...
     * </p>
     * <p>
     * Verify:when desiredType is not in the list of canConvertTo,false is returned.
     * </p>
     */
    public void testCanConvert3() {
        assertFalse("canConvert is incorrect.", AbstractionHelper.canConvert(new Long(100), Long.class,
            String.class, new Class[] {Long.class, Byte.class}));
    }
    ...
    public void testCanConvert4() {
        assertTrue("canConvert is incorrect.", AbstractionHelper.canConvert(new Long(100), Long.class,
            String.class, new Class[] {Long.class, String.class}));
    }
