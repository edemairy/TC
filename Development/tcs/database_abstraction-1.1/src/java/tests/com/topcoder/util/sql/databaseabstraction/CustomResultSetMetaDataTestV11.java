...
/**
 * Test case for CustomResultSetMetaData.
 *
 * @author justforplay
 * @version 1.1
 * @since 1.1
 */
public class CustomResultSetMetaDataTestV11 extends TestCase {
    ...
    /**
     * Initialized instance of CustomResultSetMetaData for unit test.This method will initialize the
     ...
     * </p>
     * <p>
     * Verify: CustomResultSetMetaData can be instantiated when parameter is null.
     * </p>
     *
     * @throws Exception exception to JUnit.
     */
    ...
    public void testGetColumnClassName1() throws Exception {
        assertEquals("getColumnClassName(int) is incorrect.", customRSMD.getColumnClassName(1), rsmd
    ...
    public void testGetColumnClassName3() throws Exception {
        assertNull("getColumnClassName(int) is incorrect.", customRSMD.getColumnClassName(rsmd
            .getColumnCount() + 1));
    }
    ...
    public void testGetColumnDisplaySize1() throws Exception {
        assertEquals("getColumnDisplaySize(int) is incorrect.", customRSMD.getColumnDisplaySize(1), rsmd
    ...
    public void testGetColumnDisplaySize3() throws Exception {
        assertEquals("getColumnDisplaySize(int) is incorrect.", customRSMD.getColumnDisplaySize(rsmd
            .getColumnCount() + 1), 0);
    }
    ...
    public void testGetColumnLabel1() throws Exception {
        assertEquals("getColumnLabel(int) is incorrect.", customRSMD.getColumnLabel(1), rsmd
            .getColumnLabel(1));
    }
    ...
    public void testGetColumnType3() throws Exception {
        assertEquals("getColumnType(int) is incorrect.", customRSMD.getColumnType(rsmd.getColumnCount() + 1),
            0);
    }
    ...
    public void testGetColumnTypeName1() throws Exception {
        assertEquals("getColumnTypeName(int) is incorrect.", customRSMD.getColumnTypeName(1), rsmd
            .getColumnTypeName(1));
    }
    ...
    public void testGetColumnTypeName3() throws Exception {
        assertNull("getColumnTypeName(int) is incorrect.", customRSMD
            .getColumnTypeName(rsmd.getColumnCount() + 1));
    }
    ...
    public void testGetColumnPrecision1() throws Exception {
        assertEquals("getColumnPrecision(int) is incorrect.", customRSMD.getColumnPrecision(1), rsmd
            .getPrecision(1));
    }
    ...
    public void testGetColumnPrecision3() throws Exception {
        assertEquals("getColumnPrecision(int) is incorrect.", customRSMD.getColumnPrecision(rsmd
            .getColumnCount() + 1), 0);
    }
    ...
    public void testGetColumnScale3() throws Exception {
        assertEquals("getColumnScale(int) is incorrect.", customRSMD
            .getColumnScale(rsmd.getColumnCount() + 1), 0);
    }
    ...
    public void testIsAutoIncrement1() throws Exception {
        assertEquals("isAutoIncrement(int) is incorrect.", customRSMD.isAutoIncrement(1), rsmd
            .isAutoIncrement(1));
    }
    ...
    public void testIsAutoIncrement3() throws Exception {
        assertEquals("isAutoIncrement(int) is incorrect.", customRSMD
            .isAutoIncrement(rsmd.getColumnCount() + 1), false);
    }
    ...
    public void testSetColumnClassName2() throws Exception {
        ...
        assertEquals("setColumnClassName is incorrect.",
            customRSMD.getColumnClassName(rsmd.getColumnCount()), "  ");
    }
