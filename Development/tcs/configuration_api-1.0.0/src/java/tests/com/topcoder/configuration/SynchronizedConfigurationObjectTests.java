 ...
 * @version 1.0
 */
public class SynchronizedConfigurationObjectTests extends TestCase {
    /**
     ...
     * verify the inner object can not be null.
     * </p>
     *
     * <p>
    ...
    /**
     * Test inheritance of SynchronizedConfigurationObject,
    ...
    public void test_getInnerConfigurationObject_accuracy() {
        assertTrue("The innerObject is not retrieved properly.",
                defaultco == synchronizedCo.getInnerConfigurationObject());
    }
    /**
     * <p>
    ...
    public void test_getPropertyValue_accuracy4() throws Exception {
        ...
        assertEquals("The first value of the array should be retrieved.", "v3", synchronizedCo.getPropertyValue("key"));
    }
    /**
     * <p>
    ...
    public void test_getPropertyValues_accuracy1() throws Exception {
        synchronizedCo.setPropertyValues("key", null);
        assertEquals("No value exists, empty array should be return.",
                0, synchronizedCo.getPropertyValues("key").length);
    }
    /**
     * <p>
     * The accuracy test of the method <code>getPropertyValues</code>,
    ...
    public void test_removeProperty_accuracy() throws Exception {
        ...
        //remove firstly
        assertEquals("One old value set should be retrieved by remove.",
                1, synchronizedCo.removeProperty("key").length);
        //the property now is removed
        assertNull("The key is removed, should return null.", synchronizedCo.getPropertyValue("key"));
    }
    /**
     * <p>
    ...
    public void test_clearProperties_accuracy() throws Exception {
        ...
        assertNull("The key is removed, should return null.", synchronizedCo.getPropertyValue("key1"));
        assertNull("The key is removed, should return null.", synchronizedCo.getPropertyValue("key2"));
    }
    /**
     * <p>
    ...
    public void test_clone_accuracy() throws Exception {
        ...
        assertConfigurationObjectEquals(clone.getInnerConfigurationObject(),
                synchronizedCo.getInnerConfigurationObject());
    }
    /**
