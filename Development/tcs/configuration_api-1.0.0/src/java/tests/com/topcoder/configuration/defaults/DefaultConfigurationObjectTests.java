 ...
 * @version 1.0
 */
public class DefaultConfigurationObjectTests extends TestCase {
    /**
    ...
    /**
     * Test inheritance of DefaultConfigurationObject,
     ...
     * <p>
     * The failure test of the constructor,
     * verify the name can not be full of space,
     * </p>
     *
     * <p>
     * Should have thrown IllegalArgumentException.
     ...
     * <p>
     * The failure test of the method setPropertyValue,
     * verify the value can not be an instance that is not null or Serailizable instance,
     * </p>
     *
     * <p>
     ...
     * old values of the property, or null if the key is new should be returned.
     * </p>
     *
     * @throws Exception to JUnit
     */
     ...
     * <p>
     * The failure test of the method setPropertyValues,
     * verify the values can not contains an instance that is not null or Serailizable instance,
     * </p>
     *
     * <p>
     * Should have thrown InvalidConfigurationException.
    ...
    /**
     * <p>
     * The failure test of the method containsProperty,
     * verify the key can not be null,
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * The accuracy test of the method <code>containsProperty</code>,
     * if the value is an empty array, also return true.
     * </p>
     *
     * @throws Exception to JUnit
     */
     ...
     * <p>
     * The accuracy test of the method <code>containsProperty</code>,
     * if the value is by setPropertyValues.
     * </p>
     *
     * @throws Exception to JUnit
     */
     ...
     * <p>
     * The accuracy test of the method <code>containsProperty</code>,
     * if the value is by setPropertyValue.
     * </p>
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * <p>
     * The failure test of the method getPropertyValue,
     * verify the key can not be null,
     * </p>
     *
     * <p>
    ...
    public void test_getPropertyValue_failure1() throws Exception {
        try {
            defaultCo.getPropertyValue(null);
            fail("Should have thrown IllegalArgumentException.");
        } catch (IllegalArgumentException e) {
            //pass
        }
     ...
     * if the value is an empty array, also null is returned.
     * </p>
     *
     * @throws Exception to JUnit
     */
    public void test_getPropertyValue_accuracy1() throws Exception {
        defaultCo.setPropertyValues("key", null);
        assertNull("No value exists, null should be return.", defaultCo.getPropertyValue("key"));
    }
    /**
     * <p>
     * The accuracy test of the method <code>getPropertyValue</code>.
    ...
    public void test_getPropertyValue_accuracy3() throws Exception {
        defaultCo.setPropertyValue("key", "v1");
        assertEquals("The value set should be retrieved.", "v1", defaultCo.getPropertyValue("key"));
    }
    /**
     * <p>
     * The accuracy test of the method <code>getPropertyValue</code>,
    ...
    /**
     * <p>
     * The failure test of the method getPropertyValuesCount,
     * verify the key can not be null,
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * The accuracy test of the method <code>getPropertyValuesCount</code>,
     * if the value is an empty array, 0 is returned.
     * </p>
     *
     * @throws Exception to JUnit
     */
     ...
     * <p>
     * The accuracy test of the method <code>getPropertyValuesCount</code>,
     * if there is not value, -1 is returned.
     * </p>
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * <p>
     * The failure test of the method getPropertyValues,
     * verify the key can not be null,
     * </p>
     *
     * <p>
    ...
    public void test_getPropertyValues_failure1() throws Exception {
        try {
            defaultCo.getPropertyValues(null);
            fail("Should have thrown IllegalArgumentException.");
        } catch (IllegalArgumentException e) {
            //pass
        }
    ...
    /**
     * <p>
     * The accuracy test of the method <code>getPropertyValues</code>,
     * if the value is an empty array, empty array is returned.
     * </p>
     *
     * @throws Exception to JUnit
     */
    public void test_getPropertyValues_accuracy1() throws Exception {
        defaultCo.setPropertyValues("key", null);
        assertEquals("No value exists, empty array should be return.", 0, defaultCo.getPropertyValues("key").length);
    }
    /**
     * <p>
     * The accuracy test of the method <code>getPropertyValues</code>,
     * if there is not value, null is returned.
     * </p>
     *
     * @throws Exception to JUnit
     */
    public void test_getPropertyValues_accuracy2() throws Exception {
        assertNull("Null value exists, null should be return.", defaultCo.getPropertyValues("key"));
    }
    /**
     * <p>
     * The accuracy test of the method <code>getPropertyValues</code>,
    ...
    public void test_getPropertyValues_accuracy3() throws Exception {
        defaultCo.setPropertyValue("key", "v1");
        assertEquals("One value set should be retrieved.", 1, defaultCo.getPropertyValues("key").length);
    }
    /**
     * <p>
     * The accuracy test of the method <code>getPropertyValues</code>,
    ...
    public void test_getPropertyValues_accuracy4() throws Exception {
        defaultCo.setPropertyValues("key", new String[]{"v3", "v1"});
        assertEquals("Two values should be retrieved.", 2, defaultCo.getPropertyValues("key").length);
    }
    /**
     * <p>
    ...
    /**
     * <p>
     * The accuracy test of the method <code>removeProperty</code>,
     * once the value is removed, null will return to get the property value.
     * </p>
     *
     * @throws Exception to JUnit
     */
    public void test_removeProperty_accuracy() throws Exception {
        ...
        assertNull("The key is removed, should return null.", defaultCo.getPropertyValue("key"));
    }
    /**
     * <p>
     * The accuracy test of the method <code>clearProperties</code>,
     * once the value is cleared, null will return to get the property value.
     * </p>
     *
     * @throws Exception to JUnit
     */
    public void test_clearProperties_accuracy() throws Exception {
        ...
        assertNull("The key is removed, should return null.", defaultCo.getPropertyValue("key1"));
        assertNull("The key is removed, should return null.", defaultCo.getPropertyValue("key2"));
    }
    /**
     * <p>
     * The failure test of the method getPropertyKeys,
     * verify the pattern can not be null.
     * </p>
     *
     * <p>
     * Should have thrown IllegalArgumentException.
     ...
     * <p>
     * The failure test of the method getPropertyKeys,
     * verify the pattern can not be an invalid regex.
     * </p>
     *
     * <p>
     * Should have thrown IllegalArgumentException.
    ...
    /**
     * <p>
     * The accuracy test of the method getPropertyKeys,
     * all the key match the pattern will be retrieved.
     * </p>
     *
     *
     * @throws Exception to JUnit
    ...
    /**
     * <p>
     * The accuracy test of the method getAllPropertyKeys,
     * all the key match the pattern will be retrieved.
     * </p>
     *
     *
     ...
     * <p>
     * The failure test of the method <code>addChild</code>,
     * verify the child can not be itself,
     * </p>
     *
     * <p>
     * Should have thrown InvalidConfigurationException.
     ...
     * <p>
     * The failure test of the method <code>addChild</code>,
     * verify after adding the child, cyclic relationship can not occur.
     * </p>
     *
     * <p>
     * Should have thrown InvalidConfigurationException.
     ...
     * <p>
     * The failure test of the method <code>addChild</code>,
     * verify the child must be an instance of DefaultConfigurationObject.
     * </p>
     *
     * <p>
     * Should have thrown InvalidConfigurationException.
    ...
    /**
     * <p>
     * The failure test of the method containsChild,
     * verify the name can not be null,
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * The failure test of the method getChild,
     * verify the name can not be null,
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * The failure test of the method getChildren,
     * verify the pattern can not be null,
     * </p>
     *
     * <p>
     ...
     * <p>
     * The failure test of the method getChildren,
     * verify the pattern can not be invalid regex,
     * </p>
     *
     * <p>
     * Should have thrown IllegalArgumentException.
     ...
     * all the child whose name match the pattern will be returned.
     * </p>
     *
     *
     * @throws Exception to JUnit
    ...
    /**
     * <p>
     * The accuracy test of the method <code>getAllChildrenNames</code>,
     * all the child whose name match the pattern will be returned.
     * </p>
     *
     *
    ...
    /**
     * <p>
     * The accuracy test of the method <code>getAllChildren</code>,
     * all the child whose name match the pattern will be returned.
     * </p>
     *
     *
    ...
    /**
     * <p>
     * The accuracy test of the method getAllDescendants,
     * the DefaultConfigurationObject only contains child,
     * all the children will be retrieved.
     * </p>
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * <p>
     * The failure test of the method getDescendants,
     * verify the pattern can not be null,
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * The accuracy test of the method getDescendants,
     * the tree is as follow:
     *              name
     *             /    \
     *             a    b
    ...
    /**
     * <p>
     * The failure test of the method <code>findDescendants</code>,
    ...
    /**
     * <p>
     * The accuracy test of the method <code>findDescendants</code>,
     * no Descendant is found, empty array should be return.
     * </p>
     *
     * <p>
     * The tree is as follow:
     ...
     * <p>
     * The accuracy test of the method <code>findDescendants</code>,
     * duplicated object can not be exists in the result.
     * </p>
     *
     * <p>
     * The tree is as follow:
     ...
     * <p>
     * The accuracy test of the method <code>findDescendants</code>,
     * the slashes at both end should be trimmed.
     * </p>
     *
     * <p>
     * The tree is as follow:
     ...
     * <p>
     * The accuracy test of the method <code>findDescendants</code>,
     * Continuous slashes should be considered as one.
     * </p>
     *
     * <p>
     * The tree is as follow:
    ...
    /**
     * <p>
     * The failure test of the method <code>deleteDescendants</code>,
     * verify the path can not be null.
     * </p>
     *
     * <p>
    ...
    /**
     * Assert two DefaultConfigurationObject instance is equal, but not the same one.
     * Also include the child, the compare is a deep one.
     *
     * @param obj1 the first ConfigurationObject
     * @param obj2 the second ConfigurationObject
     * @throws Exception to JUnit
     */
    private void assertConfigurationObjectEquals(ConfigurationObject obj1, ConfigurationObject obj2)
        throws Exception {
