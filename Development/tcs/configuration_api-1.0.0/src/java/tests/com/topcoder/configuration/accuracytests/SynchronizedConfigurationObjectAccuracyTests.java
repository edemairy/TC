...
public class SynchronizedConfigurationObjectAccuracyTests extends TestCase {
    ...
    /**
     * SetUp for accuracy test of the DefaultConfigurationObject,
     * create the configuration tree for accuacy test.
     * The tree as following:
     *                       root
     *                     /     \
     *                  node1    node2
     *                  /    \   /    \
    ...
    /**
     * The test of the method setPropertyValue for accuracy,
     * the value can be null, and the null is set in to the property.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method setPropertyValue for accuracy,
     * if set twice, the old value is overriden.
     *
     * @throws Exception to JUnit
     */
    public void test_accuracy_setPropertyValue2() throws Exception {
        Object[] values = synchronizedObject.setPropertyValue("key", "oldvalue");
        values = synchronizedObject.setPropertyValue("key", "newvalue");
    ...
    /**
     * The test of the method setPropertyValue for accuracy,
     * the value can be null, if null, empty array is used.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method setPropertyValue for accuracy,
     * the value array should be set into the property.
     *
     * @throws Exception to JUnit
     */
     ...
     * the property is not contains initally, after set a null values,
     * the property is also considered as contains.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getPropertyValue for accuracy,
     * no value is set, should return null.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getPropertyValue for accuracy,
     * null is set, should return null.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getPropertyValue for accuracy,
     * empty value is set, should return null.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getPropertyValue for accuracy,
     * first value of the array is retrieved.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getPropertyValues for accuracy,
     * no value is set, should return null.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getPropertyValues for accuracy,
     * null is set, but a array contains null should return.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getPropertyValues for accuracy,
     * empty value is set, should return empty array.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getPropertyValues for accuracy,
     * all the values of the array are retrieved.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getAllPropertyKeys for accuracy,
     * no key exist, empty array should be returned.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getPropertyKeys for accuracy,
     * all the keys satisfy the pattern is retrieved.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method addChild for accuracy,
     * the child is added.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method addChild for accuracy,
     * the child is added with the same name, the old one is overriden.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getChild for accuracy,
     * the child is added with the same name, the old one is overriden.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method removeChild for accuracy,
     * the child is removeed .
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method clearChildren for accuracy,
    ...
    /**
     * The test of the method getChildren for accuracy,
     * all the children whose name satisfy the pattern is returned.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getAllDescendants for accuracy,
     * the configuration of the DAG see the doc of setUp.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method getDescendants for accuracy,
     * the configuration of the DAG see the doc of setUp.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method findDescendants for accuracy,
     * the configuration of the DAG see the doc of setUp.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method findDescendants for accuracy,
     * the value with the path exists.
     * the configuration of the DAG see the doc of setUp.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method deleteDescendants for accuracy,
     * the configuration of the DAG see the doc of setUp.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method setPropertyValue for accuracy,
     * all the node alone the path set the property value.
     *
     * @throws Exception to JUnit
     */
    public void test_accuracy_setPropertyValue_withPath() throws Exception {
        ...
        assertEquals("The property value should be set into the node.", new Integer(5),
                node3.getPropertyValue("key"));
        assertEquals("The property value should be set into the node.", new Integer(5),
                node4.getPropertyValue("key"));
        assertEquals("The property value should be set into the node.", new Integer(5),
                node5.getPropertyValue("key"));
    }
    /**
     * The test of the method setPropertyValues for accuracy,
     * all the node alone the path set the property value.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method removeProperty for accuracy,
     * all the node alone the path remove the property value.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method clearProperties for accuracy,
     * all the node alone the path clear the property value.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method addChild for accuracy,
     * all the node alone the path add the child.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method removeChild for accuracy,
     * all the node alone the path remove the child.
     *
     * @throws Exception to JUnit
     */
    ...
    /**
     * The test of the method clearChildren for accuracy,
     * all the node alone the path clear the child.
     *
     * @throws Exception to JUnit
     */
    ...
    public void test_clone_accuracy() throws Exception {
        ...
        assertTrue("clone inner object should not be the same reference.",
                getPrivateField(SynchronizedConfigurationObject.class, clone, "configObj")
                    != getPrivateField(SynchronizedConfigurationObject.class, synchronizedObject, "configObj"));
    }
    /**
