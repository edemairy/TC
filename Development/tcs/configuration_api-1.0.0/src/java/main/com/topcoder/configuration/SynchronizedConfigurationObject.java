...
/**
 * <p>
 * A synchronized wrapper of any ConfigurationObject.
 * Every method call should be synchronized on the inner configObj before delegating
 * to the inner ConfigurationObject. But please note that,
 * this wrapper can only ensure the methods declared in ConfigurationObject work together thread safely.
 * Because only these methods are synchronized.
 * And extension of this class should lock the inner configObj to ensure thread safe.
 * </p>
 *
 * <p>
...
public class SynchronizedConfigurationObject implements ConfigurationObject {
    /**
     * <p>
     * Represents the inner ConfigurationObject.
     * This class provides a synchronized wrapper to this configuration object.
     * All the methods calls are delegated to this config obj.
     * </p>
     *
     * <p>
     * It is initialized in the constructor, and never changed later.
     * It cann't be null. It can be accessed by protected getter.
     * </p>
     *
     */
     ...
     * </p>
     *
     * @param configObj A ConfigurationObject instance to be wrapped
     * @throws IllegalArgumentException if configObj is null.
     */
    ...
    /**
     * <p>
     * A protected getter for inner configObj field.
     * This method is provided for sub-classes to use the inner ConfigurationObject.
     * </p>
     *
     ...
     * @return the old values of the property, or null if the key is new.
     * @param key the key of property
     * @param values the array of value Object to be set
     * @throws IllegalArgumentException if key is null or empty
     * @throws InvalidConfigurationException if given key or value is not accepted by the specific implementation.
     ...
     * @throws IllegalArgumentException if key or path is null, or key is empty.
     * @throws InvalidConfigurationException if given key or value is not accepted by inner Object.
     * @throws ConfigurationAccessException if any other error occurs.
     */
